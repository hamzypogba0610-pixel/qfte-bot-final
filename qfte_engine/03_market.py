    ...
    data["marches"] = [
        {
            ...
            "cote": round(cote_ah_f, 2),
            "cote_ouverture": round(cote_ah_f * 1.02, 2),
        ...
        },
        {
            "nom": "BTTS",
            "selection": "Oui",
            "cote": round(cote_btts_f, 2),
            "cote_ouverture": round(cote_btts_f * 1.02, 2),
...
def _analyser_basket(data, match):
    ...
    if ev_over >= ev_under:
        selection_ou = "Over 180.5"
        proba_ou = proba_over_tot
        cote_ou = cote_over_brute
    else:
        selection_ou = "Under 180.5"
